    ...
    <div>
      <section className='home-intro-section'>
        <section className='home-brief-intro'>
          <h1>
          <span role='img'>👋🏿 </span> Hi, my name is <span className='intro-name'>Oluwajuwon</span> You can call me a tech bro if you want
          </h1>
          <p>
            ...
            I'm guessing you're not here to read my rants , so you can checkout the other pages via the links at the bottom of the page or click on any of the icons below
          </p>
        </section>
